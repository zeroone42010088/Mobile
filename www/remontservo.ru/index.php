...
<div class=how-body>
<p><img class="howbodyimg" style=height:100px src=fonts/mess.png alt=message /><br><strong>1.</strong> Вы оставляете заявку</p>
</div>
<div class=how-body>
<p><img class="howbodyimg" style=height:100px src=fonts/phone.png alt=telephone /><br><strong>2.</strong> Мы связываемся с Вами<br>уточняем детали</p>
</div>
<div class=how-body>
<p><img class="howbodyimg" style=height:100px src=fonts/compose.png alt=compose /><br><strong>3.</strong> Заключаем договор</p>
</div>
<div class=how-body>
<p><img class="howbodyimg" style=height:100px src=fonts/check.png alt=check /><br><strong>4.</strong> Выполняем работу</p>
</div>
</div> 
</main>
</div>
